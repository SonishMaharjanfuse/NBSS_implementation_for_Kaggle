        ...
        if os.path.exists(wav_cfg_path):
            ...
            for key, dataset in {'train': 'tr', 'validation': 'cv', 'test': 'tt'}.items():
                ...
                for i in range(num_files):
                    ...
                    inwav3_name, inwav4_name = dfi[4], dfi[6]
                    inwav1_snr, inwav2_snr = dfi[1], dfi[3]
                    inwav3_snr, inwav4_snr = dfi[5], dfi[7]
                    ...
                    spk3_cfg.append({'wav': inwav3_name, 'speaker': spk_name3, 'gender': gender3, 'dataset': f"wsj0-mix/{key}"})
                    spk4_cfg.append({'wav': inwav4_name, 'speaker': spk_name4, 'gender': gender4, 'dataset': f"wsj0-mix/{key}"})
